...
* Fork the ``Lambda`` repo into your account.

* Obtain the source by cloning it onto your development machine.

  .. code-block:: console

      $ git clone git@github.com:your_name_here/Lambda.git
      $ cd Lambda
...
* Create and activate a Python virtual environment for local development. This
  ...
  .. note::
      ...
      (Lambda) is used to indicate when the commands
