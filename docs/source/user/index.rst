...
The simplest way to install Lambda is using Pip.

.. code-block:: console

    $ pip install Lambda

This will install ``Lambda`` and all of its dependencies.
...
Report bugs at the `issue tracker <https://github.com/MaciejWas/Lambda/issues>`_.
