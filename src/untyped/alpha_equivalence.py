    ...
    match term1:
        ...
        case Application(of, on):
            ...
            return is_alpha_equivalent(
                of, term2.of, bounded_vars
            ) and is_alpha_equivalent(on, term2.on, bounded_vars)
        ...
        case Abstraction(bound_var, expr):
            ...
            converted_other_expr = alpha_conversion(
                other_expr, other_bound_var, bound_var
            )

            return is_alpha_equivalent(
                expr, converted_other_expr, bounded_vars + [bound_var]
            )
